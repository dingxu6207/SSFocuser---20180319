...
{		
	  ...
	  GPIO_PinRemapConfig(GPIO_Remap_SWJ_Disable, ENABLE);
		...
		RCC_APB2PeriphClockCmd( LED4_GPIO_CLK | LED5_GPIO_CLK , ENABLE);
		RCC_APB2PeriphClockCmd( M0_GPIO_CLK | M1_GPIO_CLK | M2_GPIO_CLK , ENABLE);
		RCC_APB2PeriphClockCmd( RST_GPIO_CLK | SLF_GPIO_CLK , ENABLE);
